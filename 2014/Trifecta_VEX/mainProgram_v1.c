...
#pragma config(Motor,  port5,           motorD,        tmotorVex393, PIDControl, encoder, encoderPort, I2C_3, 1000)
...
task main()
{
	...
	motor[motorD]  = 34;		  // Motor on port3 is run at full (127) power forward
